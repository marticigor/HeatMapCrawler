 ...
 * If a value is given outside that range, it is changed to be within that
 * range. As such, a negative value would be set to 0 and a value greater than
 * 255 would be set to 255.
 * 
 * <P>
 * Example usage:
 * 
...
public class Pixel {
	 ...
	 * 
	 * @param i
	 *            the integer value representing all the color components
	 * @param x
	 ...
	 * parameter. If it is not in the range of 0-255 it is changed to be in that
	 * range.
	 * 
	 * @param r
	 *            the red value
