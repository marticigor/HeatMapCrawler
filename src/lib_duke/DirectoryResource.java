 ...
 * more files from a directory (or folder) with a file selection dialog box by
 * using the method <code>selectedFiles</code>. These files can then be iterated
...
public class DirectoryResource {
	...
	public Iterable<File> selectedFiles() {
		...
		if (files[0] == null) {
			// return empty list rather than null, so others can throw the
			// exception if needed
