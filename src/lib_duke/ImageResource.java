...
/**
 * The <code>ImageResource</code> class represents an image as a grid of
 * <code>Pixel</code> objects and allows access to all of them, using the method
 * <code>pixels</code>. These pixels can then be iterated over using a
 * <code>for</code> loop.
 * 
 * <P>
 * Note, no changes made to the pixels in this image affect the original image
 * opened unless you use the method <code>save</code>.
 * 
 * <P>
 * Example usage:
 * 
...
public class ImageResource {
	 ...
	 * height passed as parameters and whose pixels are all black.
	 * 
	 * @param width
	 ...
	 * @throws exception
	 *             if the width or height are not positive values
	 */
	 ...
	 * @throws exception
	 *             if the file cannot be accessed or is not in an image format
	 */
	 ...
	 * 
	 * @param x
	 *            the column position of the pixel
	 * @param y
	 *            the row position of the pixel
