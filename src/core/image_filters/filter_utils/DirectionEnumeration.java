...
public class DirectionEnumeration {
	...
	public static void testPrint() {
		...
		int[] xA = new int[] { 0, 0, -80, 80 };
		int[] yA = new int[] { -80, 80, 0, 0 };
	...
	public static Direction getDirection(double dirD) {
		...
		if ((dirD >= DIRDEG[7] || dirD < DIRDEG[0]))
			return Direction.S;
		if ((dirD >= DIRDEG[3] && dirD < DIRDEG[4]))
			return Direction.N;

		if ((dirD >= DIRDEG[0] && dirD < DIRDEG[1]))
			return Direction.SE;
		if ((dirD >= DIRDEG[4] && dirD < DIRDEG[5]))
			return Direction.NW;

		if ((dirD >= DIRDEG[1] && dirD < DIRDEG[2]))
			return Direction.E;
		if ((dirD >= DIRDEG[5] && dirD < DIRDEG[6]))
			return Direction.W;

		if ((dirD >= DIRDEG[2] && dirD < DIRDEG[3]))
			return Direction.NE;
		if ((dirD >= DIRDEG[6] && dirD < DIRDEG[7]))
			return Direction.SW;
	...
	public enum Direction {
		...
		N((byte) 0, (byte) -1), NE((byte) 1, (byte) -1), E((byte) 1, (byte) 0), SE((byte) 1, (byte) 1), S((byte) 0,
				(byte) 1), SW((byte) -1, (byte) 1), W((byte) -1,
						(byte) 0), NW((byte) -1, (byte) -1), ZERO((byte) 0, (byte) 0), ERROR((byte) 0, (byte) 0);
