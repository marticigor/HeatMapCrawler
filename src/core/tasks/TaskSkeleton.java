...
public class TaskSkeleton extends BaseTask {
    ...
    protected void compute() {
        //System.out.println("COMPUTE SKELETON ON THREAD " + Thread.currentThread() + this.toString());
        ip.procesSkeleton(xFromIncl, xToExcl, yFromIncl, yToExcl, false); //false for real segments
    }
